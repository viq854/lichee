...
public class SPBuilder {
	...
	public SPBuilder(Map<String, Integer> mutMap, ArrayList<ArrayList<Integer>> noConflictMatrixPrime, Set<ArrayList<Integer>> conflicts, 
		...
		currTree = assembleGraph(noConflictMatrixPrime, LColFuncMap, mutMap, edgeToCodeMap, testName);
...
//		}
	...
	private Integer ExtendNode(Integer currNode,
			...
			Map<String, Integer> mutMap, String testName, Map<String, Integer> redEdgeMap) {
...
//	}
	...
	private void outputSubPopFile(Integer A, Integer B,
			ArrayList<ArrayList<Integer>> matrixPrime,
			Map<String, Integer> mutMap, int numRows, String testName) {
		// TODO Auto-generated method stub
